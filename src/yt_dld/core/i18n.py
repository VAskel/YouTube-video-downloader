...
STRINGS = {
    ...
    "settings_fragment_concurrency": {"ru": "Параллельные фрагменты:", "en": "Parallel fragments:"},
    "fragment_concurrency_reliable": {"ru": "Надежно (1)", "en": "Reliable (1)"},
    "fragment_concurrency_balanced": {"ru": "Баланс (2)", "en": "Balanced (2)"},
    "fragment_concurrency_fast": {"ru": "Быстро (4)", "en": "Fast (4)"},
